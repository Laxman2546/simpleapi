...
def result():
    try:
        ...
        # Debug logging
        print(f"API Request - Query: '{query}', lyrics: {lyrics_}")
        ...
        try:
            ...
            if not all_results:
                print("Trying jiosaavn module as fallback")
                try:
                    results = jiosaavn.search_for_song(query, lyrics, True, limit=fetch_limit, timeout=8)
